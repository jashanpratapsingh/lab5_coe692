...
public class DBConnection {
    ...
    public Connection getConnection() throws SQLException {
        ...
        String host = resolve(p, "db.host", "CATALOG_DB_HOST", "DB_HOST", "localhost");
        String port = resolve(p, "db.port", "CATALOG_DB_PORT", "DB_PORT", "3306");
        String name = resolve(p, "db.name", "CATALOG_DB_NAME", "DB_NAME", "Catalog_Rental_Lab5_DB");
        String user = resolve(p, "db.user", "CATALOG_DB_USER", "DB_USER", "root");
        String pass = resolve(p, "db.password", "CATALOG_DB_PASSWORD", "DB_PASSWORD", "root");
