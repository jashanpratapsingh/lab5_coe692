...
<body>
  ...
  <script>
    ...
    updateHeaderToken();
    document.getElementById('hUser').value = getUser() || 'student1';

    async function loadHistory() {
      const user = document.getElementById('hUser').value;
      const res = await requestJson(`${API.checkout}/rentals/history/${encodeURIComponent(user)}`);
      renderHistoryResult('historyOut', res);
    }
  </script>
</body>
</html>
