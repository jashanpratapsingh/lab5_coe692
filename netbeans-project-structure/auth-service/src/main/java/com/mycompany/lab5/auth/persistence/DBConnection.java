...
public class DBConnection {
    ...
    public Connection getConnection() throws SQLException {
        ...
        String host = resolve(p, "db.host", "AUTH_DB_HOST", "DB_HOST", "localhost");
        String port = resolve(p, "db.port", "AUTH_DB_PORT", "DB_PORT", "3306");
        String name = resolve(p, "db.name", "AUTH_DB_NAME", "DB_NAME", "Auth_Rental_Lab5_DB");
        String user = resolve(p, "db.user", "AUTH_DB_USER", "DB_USER", "root");
        String pass = resolve(p, "db.password", "AUTH_DB_PASSWORD", "DB_PASSWORD", "root");
