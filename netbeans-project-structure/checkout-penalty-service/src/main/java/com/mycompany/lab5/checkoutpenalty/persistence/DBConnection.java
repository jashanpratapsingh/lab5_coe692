...
public class DBConnection {
    ...
    public Connection getConnection() throws SQLException {
        ...
        String host = resolve(p, "db.host", "CHECKOUT_DB_HOST", "DB_HOST", "localhost");
        String port = resolve(p, "db.port", "CHECKOUT_DB_PORT", "DB_PORT", "3306");
        String name = resolve(p, "db.name", "CHECKOUT_DB_NAME", "DB_NAME", "CheckoutPenalty_Rental_Lab5_DB");
        String user = resolve(p, "db.user", "CHECKOUT_DB_USER", "DB_USER", "root");
        String pass = resolve(p, "db.password", "CHECKOUT_DB_PASSWORD", "DB_PASSWORD", "root");
