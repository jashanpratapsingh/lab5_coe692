...
public class DBConnection {
    ...
    public Connection getConnection() throws SQLException {
        ...
        String host = resolve(p, "db.host", "INVENTORY_DB_HOST", "DB_HOST", "localhost");
        String port = resolve(p, "db.port", "INVENTORY_DB_PORT", "DB_PORT", "3306");
        String name = resolve(p, "db.name", "INVENTORY_DB_NAME", "DB_NAME", "Inventory_Rental_Lab5_DB");
        String user = resolve(p, "db.user", "INVENTORY_DB_USER", "DB_USER", "root");
        String pass = resolve(p, "db.password", "INVENTORY_DB_PASSWORD", "DB_PASSWORD", "root");
